  ...
  return (
    <div className="rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-slate-800/60 border-b border-gray-200 dark:border-slate-700">
        <div>
          <p className="text-sm font-medium text-gray-900 dark:text-slate-100">AI Diagnosis</p>
          {mutation.data && (
        ...
        {mutation.data && (
          <>
            ...
            <div className="mt-3 pt-3 border-t border-gray-100 dark:border-slate-800 flex items-center justify-between">
              <p className="text-xs text-gray-400 dark:text-slate-500">AI-generated — verify before acting.</p>
